import argparse
import data_loader_rigid2 as data_loader_rigid2
import os
...
def get_args():
    ...
    loader_param = data_loader_rigid2.set_data_loader_params(args)
...
def get_args_inference():
    ...
    trunk_group.add_argument('-n_extra_block', type=int, default=4,
            help="Number of iteration blocks for extra sequences [4]")
    trunk_group.add_argument('-n_main_block', type=int, default=36,
            help="Number of iteration blocks for main sequences [48]")
    trunk_group.add_argument('-n_ref_block', type=int, default=4,
            help="Number of refinement layers [4]")
    trunk_group.add_argument('-d_msa', type=int, default=256,
    ...
    model_subname= "samechain"#""sc_lj" 
    default_model = f"home/kkh517/submit_files/Project/halfblood/models_{model_subname}/RF2_apr23_best.pt"
    inference_group = parser.add_argument_group("inference parameters")
    inference_group.add_argument("-heavy_a3m_tmp", default='', type =str, help="list of heavy chain MSA files")
    inference_group.add_argument("-light_a3m_tmp", default='', type =str, help="list of light chain MSA files")
    inference_group.add_argument("-antigen_a3m_tmp", default='', type =str, help="list of heavy chain MSA files")
    inference_group.add_argument("-antibody_template_pdb", default='', type=str, help="antibody template pdb path")
    inference_group.add_argument("-antigen_template_pdb", default='', type=str, help="antigen template pdb path")
